...
function App() {
  ...
  const handleOpenProductModal = (mode, product)=>{
    ...
    try{
      ...
      // setTempProduct((product == null)?defaultModalState:product)
    }
    catch(e){}
  ...
  const handleModalInputChange = (e) =>{
    const {value, name, checked, type} = e.target; // checked, type 勾選
    setTempProduct({
      ...tempProduct,
          ...
          <div className="row">
            <div className="col">
              <div className="d-flex justify-content-between">
                <h2>產品列表</h2>
                <button onClick={() => handleOpenProductModal('create',null) }
